...
CREATE TABLE Notifications (
    ...
    related_post_id INT NULL, -- post that was commented
...
INSERT INTO TravelPosts (user_id, media_url, media_type, continent, country, city, start_date, end_date, description) VALUES (2, 'Rome.jpg', 'image', 'Europe', 'Italy', 'Rome', '2023-01-05', '2023-01-10', 'This is a trip to Rome');
...
INSERT INTO TravelPosts (user_id, media_url, media_type, continent, country, city, start_date, end_date, description) VALUES (1, 'NewYork.jpg', 'image', 'North America', 'USA', 'New York', '2018-07-31', '2018-08-05', 'This is a trip to New York');
...
INSERT INTO TravelPosts (user_id,  media_url, media_type, continent, country, city, start_date, end_date, description) VALUES (1, 'Hanoi.jpg', 'image', 'Asia', 'Vietnam', 'Hanoi', '2023-05-15', '2023-05-28', 'This is a trip to Hanoi');
...
INSERT INTO Notifications (user_id, notification_text, notification_type, related_post_id, related_user_id) VALUES (2, 'User commented on your post', 'Comment', '1', '1');
